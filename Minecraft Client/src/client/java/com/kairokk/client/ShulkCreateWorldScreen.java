...
/** Branded world setup screen. */
public final class ShulkCreateWorldScreen extends SimpleScreen {
	private final Screen parent;

	public ShulkCreateWorldScreen(Screen parent) {
		super(new ShulkCreateWorldFragment(parent), new Callback(), null, Component.empty());
		this.parent = parent;
	}
