...
public final class ShulkSettingsFragment extends Fragment {
	...
	public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
		...
		if ("Controls".equals(pageTitle) || "Language".equals(pageTitle) || "Accessibility".equals(pageTitle) || "Sounds".equals(pageTitle)) {
			ScrollView scroll = new ScrollView(context);
			scroll.setFillViewport(true);
			scroll.setEdgeEffectColor(0xFF3D8BFF);
			scroll.setBottomEdgeEffectColor(0xFF3D8BFF);
			scroll.addView(content, new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
