...
public final class ShulkDirectConnectScreen extends SimpleScreen {
	private final Screen parent;
	public ShulkDirectConnectScreen(Screen parent) { super(new ShulkDirectConnectFragment(parent), new Callback(), null, Component.empty()); this.parent = parent; }
