...
public final class ShulkServerFormScreen extends SimpleScreen {
	private final Screen parent;

	public ShulkServerFormScreen(Screen parent, String title, ServerData server, Consumer<ServerData> onSave) {
		super(new ShulkServerFormFragment(parent, title, server, onSave), new Callback(), null, Component.empty());
		this.parent = parent;
	}
