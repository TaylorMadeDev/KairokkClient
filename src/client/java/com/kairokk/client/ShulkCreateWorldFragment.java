...
public final class ShulkCreateWorldFragment extends Fragment {
	...
	public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
		...
		TextView note = text(context, "Advanced data-pack and world-type options remain on Minecraft defaults.", 13, 0xFF817984);
	...
	private void createWorld() {
		...
		Core.executeOnMainThread(() -> ShulkCreateWorldRequest.create(parent, finalName, finalSeed,
			mode, difficulty, commands, structures, bonusChest));
	}
